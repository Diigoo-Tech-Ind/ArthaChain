...
fn get_evm_wallets() -> Vec<WalletInfo> {
    vec![
        WalletInfo {
            ...
            supported_networks: vec!["External Chain 1".to_string(), "External Chain 2".to_string(), "External Chain 3".to_string(), "ArthaChain Mainnet".to_string()],
        ...
        WalletInfo {
            ...
            supported_networks: vec!["External Chain 1".to_string(), "External Chain 2".to_string(), "ArthaChain".to_string()],
        ...
        WalletInfo {
            ...
            supported_networks: vec!["External Chain 1".to_string(), "External Chain 3".to_string(), "ArthaChain".to_string()],
...
fn get_all_ides() -> Vec<IDEInfo> {
    vec![
        ...
        IDEInfo {
            ...
            url: "https://remix.ethereum.org/".to_string(), // External IDE URL
        ...
        IDEInfo {
            ...
            supports: vec!["WASM".to_string()],
            features: vec!["IBC".to_string(), "Rust".to_string(), "Cross-chain".to_string()],
